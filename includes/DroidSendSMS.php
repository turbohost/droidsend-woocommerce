...
class DroidSendSMS
{
    ...
    public $prefix = 'droidsend_sms_woo_';
    ...
    {
        /*
         * Add DroidSend SMS to woo-commerce settings.
         */
        $triggerAPI = new DroidSendTrigger();
        add_filter('woocommerce_settings_tabs_array', array($this, 'add_settings_tab') , 50);
        add_action('woocommerce_settings_tabs_settings_tab_droidsend', array($this, 'settings_tab'));
        add_action('woocommerce_update_options_settings_tab_droidsend', array($this, 'update_settings'));
    }

    public function add_settings_tab($settings_tabs)
    {
        $settings_tabs['settings_tab_droidsend'] = __('DroidSend SMS', $this->prefix);
    ...
    private function getFields()
    {
        ...
        $fields[] = array(
            'title' => __('DroidSend Settings', $this->prefix),
            'type' => 'title',
            'desc' => 'Provide following details from your DroidSend account. <a href="https://app.droidsend.com/api.php" target="_blank">Click here</a> to go to API KEY section.',
            'id' => $this->prefix . 'droidsend_settings'
        );

        $fields[] = array(
            'title' => __('API Key', $this->prefix),
            'id' => $this->prefix . 'api_key',
            'desc_tip' => __('API key available in your DroidSend account.', $this->prefix),
            'type' => 'text',
            'css' => 'min-width:300px;',
        );

        $fields[] = array(
            'title' => __('Device ID', $this->prefix),
            'id' => $this->prefix . 'device_id',
            'desc_tip' => __('Device id available in your DroidSend account settings page.', $this->prefix),
            'type' => 'text',
            'css' => 'min-width:300px;',
        );
        ...
        $fields[] = array(
            ...
            'desc' => 'Enter admin mobile numbers. You can use multiple numbers by separating with a comma.<br> Example: +258841234567, +258851234567.',
            'desc_tip' => 'Enter admin mobile numbers. You can use multiple numbers by separating with a comma.<br> Example: +258841234567, +258851234567.',
            'default' => '',
            'type' => 'text'
        );
        $fields[] = array(
         ...
         */
        $fields[] = array('type' => 'sectionend', 'id' => $this->prefix . 'shortcode_settings');
        ...
        $fields[] = array(
            ...
            'id' => $this->prefix . 'shortcode_settings'
        );
